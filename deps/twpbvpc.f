...
c
     ...
     *      ipvblk,isign,amg,c1,wrkrhs,ckappa1,gamma1)
          ...
          if (iprint .ge. 0) then
C
C     COMPUTE ESTIMATION OF THE CONDITION NUMBER KAPPA
C
...
c       if ((.not. stab_cond) .and. errmax .ge. 1.0d6  ) then
...
c
c      else
cf   the conditining and the error
...
C Was absent from the main code
